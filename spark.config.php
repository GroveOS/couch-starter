<?php
    ...
    define( 'K_SITE_URL', '<spark-site-url>' );
    ...
    define( 'K_GMT_OFFSET', date('I') ? -4 : -5 ); // Eastern Time (USA) (UTC-05:00)
    ...
    define( 'K_DB_NAME', '<spark-db-name>' );
    // 5.
    // Database username
    define( 'K_DB_USER', '<spark-db-user>' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', '<spark-db-pass>' );
    // 7.
    ...
    define( 'K_REMOVE_FOOTER_LINK', <spark-remove-footer-link> );
